            ...
            <div className="home_section">
                ...
                <div className="slide_part">
                    <div className="left_slide">
                        {isProductsAvailable && <Slide title="Deal Of The Day" products={products} />}
                    </div>
                ...
                {isProductsAvailable && <Slide title="Today's Deal" products={products} />}

                <div className="center_img">
                    <img src="https://m.media-amazon.com/images/G/31/AMS/IN/970X250-_desktop_banner.jpg" alt="" />
                </div>

                {isProductsAvailable && <Slide title="Best Seller" products={products} />}
                {isProductsAvailable && <Slide title="Upto 80% off" products={products} />}
            </div>
